...
class Studiengang:
    ...
    def __init__(self, eingabe_student: Student, eingabe_studiengang, eingabe_abschluss, eingabe_datum_start):
        self.student = eingabe_student  # verknüftes Objekt -> Aggregation: Studiengang ist darauf angewiesen, dass Student existiert
    ...
    def ausgabe_dict(self):
        ...
        """
        daten_student = self.student.ausgabe_dict()
        daten_studiengang = {
...
class CSV_Controller:
    ...
    def setze_student_csv(self, eingabe_name, eingabe_matrikelnummer, eingabe_studiengang, eingabe_abschluss, eingabe_datum_start):
        ...
        neue_zeile = self.studium.ausgabe_dict()
    ...
    def füge_modul_csv_hinzu(self, eingabe_name, eingabe_ects, eingabe_datum_start, eingabe_datum_prüfung, eingabe_note):
        ...
        spalten = ["Modul", "ECTS", "Start", "Ende", "Note", "Dauer"]
        neue_zeile = self.prüfungsleistung.ausgabe_dict()
...
class Plots_Berechnungen:
    ...
    def plot_verteilung_noten(self):
        ...
        ax = fig.add_subplot(111)
        ax.bar(häufigkeit.index.astype(str), häufigkeit.values, color="gray", edgecolor="black")
        ax.set_xlabel("Note")
    ...
    def plot_verlauf_noten(self):
        ...
        ax.plot(self.read_module_csv["Index"], durchschnitt_gleitend, linewidth=4, alpha=0.3, label="Gleitender Durchschnitt", color="grey")
    ...
    def plot_dauer_modul_semester(self):
        """
        Erstellt Balkendiagramm durchschnittlicher Bearbeitungsdauer für ein 
        Modul je Semester.
        ...
        durchschnitt = self.read_module_csv.groupby("Semester")["Dauer"].mean()

        fig = Figure(figsize=(2, 7), dpi=90)
        ax = fig.add_subplot(111)
        ax.bar(durchschnitt.index, durchschnitt.values, color="grey", width=0.6)
        ax.set_xlabel("Semester")
        ax.set_ylabel("Tage/Modul")
    ...
    def tabelle_module(self):
        """
        Erstellt Tabelle mit Modulen, Noten und Bearbeitungsdauer.
        Zeigt nur relevante Spalten aus Modul-CSV.
        """
        module_csv_kurz = self.read_module_csv[["Modul", "Dauer", "Note"]]
...
CSV_Controller().setze_student_csv("Phillip Riemer", "UI123456", "Angewandte KI", "Bachelor of Science", "15.01.2025")
